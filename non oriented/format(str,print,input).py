...
o método format() em python serve basicamente para criar uma string que contém campos
entre chaves que são substituidos pelos argumentos de format.
...
frase= "{0} e {1} gostam de jogar futebol. Porém, {0} e {2} não gostam de voley.".format("Joao", "Maria","Pedro")
print(frase)
...
# No caso de valores reais, podemos definir o número de dígitos
#a serem apresentadas após o ponto decimal
...
print("O saltador {:10} saltou {:7}".format('Luiz', 7.23))
